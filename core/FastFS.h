...
class FastFS {
 ...
 public:
   ...
   */
  bool lookup(uint32_t parentId, std::string_view name,
...
class FastInode {
 ...
 public:
  ...
  void create(
      uint32_t ino, uint32_t parentId, std::string_view name, FileType type);
